...
public class ShipApi {
	...
	public LABELRECOVERYResponseWrapper labelRecovery(String version,
		...
		return this.labelRecoveryWithHttpInfo(version, laBELRECOVERYRequestWrapper, transId, transactionSrc).getBody();
	}
	...
	public ResponseEntity<LABELRECOVERYResponseWrapper> labelRecoveryWithHttpInfo(String version,
		...
		if (transId != null)
			localVarHeaderParams.add("transId", this.apiClient.parameterToString(transId));
		if (transactionSrc != null)
			localVarHeaderParams.add("transactionSrc", this.apiClient.parameterToString(transactionSrc));
		...
		return this.apiClient.invokeAPI("/labels/{version}/recovery", HttpMethod.POST, uriVariables, localVarQueryParams,
	...
	public String shipment(String version, SHIPRequestWrapper shIPRequestWrapper, String transId, String transactionSrc,
		...
		return this.shipmentWithHttpInfo(version, shIPRequestWrapper, transId, transactionSrc, additionaladdressvalidation)
				.getBody();
	}
	...
	public ResponseEntity<String> shipmentWithHttpInfo(String version, SHIPRequestWrapper shIPRequestWrapper,
		...
		localVarQueryParams.putAll(
				this.apiClient.parameterToMultiValueMap(null, "additionaladdressvalidation", additionaladdressvalidation));
		...
		return this.apiClient.invokeAPI("/shipments/{version}/ship", HttpMethod.POST, uriVariables, localVarQueryParams,
				localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept,
				localVarContentType, localVarAuthNames, localReturnType);
	}
	...
	public VOIDSHIPMENTResponseWrapper voidShipment(String version, String shipmentidentificationnumber, String transId,
		...
		return this.voidShipmentWithHttpInfo(version, shipmentidentificationnumber, transId, transactionSrc, trackingnumber)
				.getBody();
	}
	...
	public ResponseEntity<VOIDSHIPMENTResponseWrapper> voidShipmentWithHttpInfo(String version,
		...
		localVarQueryParams.putAll(this.apiClient.parameterToMultiValueMap(null, "trackingnumber", trackingnumber));
		...
		return this.apiClient.invokeAPI("/shipments/{version}/void/cancel/{shipmentidentificationnumber}", HttpMethod.DELETE,
